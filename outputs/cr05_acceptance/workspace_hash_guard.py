...
def snapshot() -> dict[str, object]:
    files = [PROJECT_ROOT / name for name in ("build_network.py", "env.py", "scan_demand.py")]
    files.extend(PROJECT_ROOT / "tests" / name for name in ("test_build_network.py", "test_env_runner.py", "test_scan_demand.py"))
